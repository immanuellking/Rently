  ...
  return (
    <div className="w-full bg-[#F4F4F4] px-5 lg:px-14 py-14 lg:py-16">
      ...
      <div className=" w-full flex items-center justify-center gap-x-2">
        <div className="w-10 h-10 border-[1.5px] border-gray-300 rounded-full flex items-center justify-center cursor-pointer text-gray-500 font-semibold hover:bg-brightBlue hover:border-brightBlue hover:text-white duration-300 ease-in-out" onClick={goToPrev}>
          <FaLessThan />
        </div>
        <div className="flex items-center gap-x-2">
          {pageButtons.map((_, index) => {
            return (
              <div className={`${currentPage === index + 1 ? "bg-brightBlue border-brightBlue text-white" : "border-gray-300 bg-transparent text-gray-500"} w-10 h-10 border-[1.5px] rounded-full flex items-center justify-center cursor-pointer font-semibold hover:bg-brightBlue hover:border-brightBlue hover:text-white duration-300 ease-in-out`}>
                {index + 1}
              </div>
            );
          })}
        </div>
        <div className="w-10 h-10 border-[1.5px] border-gray-300 rounded-full flex items-center justify-center cursor-pointer text-gray-500 font-semibold hover:bg-brightBlue hover:border-brightBlue hover:text-white duration-300 ease-in-out" onClick={goToNext}>
          <FaGreaterThan />
        </div>
      </div>
    </div>
