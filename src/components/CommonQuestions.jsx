...
const faqsData = [
  {
    tab: "How does Spleet Work?",
    id: 1,
    isOpen: false,
    text: (
      <div className="font-medium text-[#6d6d6e] space-y-6">
        <p>
          At Spleet, we offer access to premium residential solutions with
  ...
  {
    tab: "Does Spleet organise viewings?",
    id: 2,
    isOpen: false,
    text: (
  ...
  {
    tab: "Does Spleet own the spaces listed?",
    id: 3,
    isOpen: false,
    text: (
      <div className="font-medium text-[#6d6d6e]">
        <p>
          No Spleet does not own the spaces listed, as we have homeowners that
      ...
      <div>
        <div className="space-y-4">
          ...
          <div className="space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <p className="w-[75%] text-sm text-[#6d6d6e] font-semibold">
              Get quick answers to all your questions and concerns about Spleet
              and Spleet homes. Whether as a member, host or just a visitor, we
      ...
      <div className="space-y-8">
        {faqs.map((faq, index) => {
          ...
          return (
            <div
              key={index}
              className="space-y-6 border-b-2 border-[#E6E9FB] pb-5"
            >
              <div className="flex justify-between">
                <h1 className="text-lg font-bold m-0">{tab}</h1>
                <div
